...
.k-rtl .k-pager-nav + .k-pager-numbers,
[dir="rtl"] .k-pager-nav + .k-pager-numbers,
.k-rtl .k-pager-nav + .k-pager-numbers-wrap,
[dir="rtl"] .k-pager-nav + .k-pager-numbers-wrap,
.k-rtl .k-pager-numbers + .k-pager-nav,
[dir="rtl"] .k-pager-numbers + .k-pager-nav,
.k-rtl .k-pager-numbers .k-current-page ~ li + li,
[dir="rtl"] .k-pager-numbers .k-current-page ~ li + li,
...
.k-edge .k-grid-header .k-header-column-menu {
  ...
  margin-right: calc(-1 * (2px + 0.75rem + 1.5em));
}
...
.k-ie .k-textbox.k-invalid:-ms-input-placeholder,
.k-ie .k-textbox.k-state-invalid:-ms-input-placeholder,
.k-ie .k-textbox.ng-invalid.ng-touched:-ms-input-placeholder,
.k-ie .k-textbox.ng-invalid.ng-dirty:-ms-input-placeholder,
