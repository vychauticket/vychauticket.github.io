...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1122), __webpack_require__(1139), __webpack_require__(1010), __webpack_require__(1060) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	    ...
	    var defaultMobileTemplate =
	        '<div data-#=ns#role="view" class="k-grid-filter-menu">' +
	            ...
	            '<form title="#=messages.title#" class="k-filter-menu k-mobile-list">' +
	                '<ul>' +
	                    '<li>' +
	                        '<span class="k-filter-help-text">#=messages.info#</span>' +
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                            ...
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-input-text">#=messages.value#</span>' +
	                                    '#if(values){#' +
	                        ...
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-logic-and-text">#=messages.and#</span>' +
	                                    '<input id="and_#=filterMenuGuid#" title="#=messages.and#" type="radio" name="logic" class="k-radio" data-#=ns#bind="checked: logic" value="and" autocomplete="'+AUTOCOMPLETEVALUE+'" />' +
	                                    '<span class="k-radio-label"></span>' +
	                                '</label>' +
	                            '</li>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-logic-or-text">#=messages.or#</span>' +
	                                    '<input id="or_#=filterMenuGuid#" title="#=messages.or#" type="radio" name="logic" class="k-radio" data-#=ns#bind="checked: logic" value="or" autocomplete="'+AUTOCOMPLETEVALUE+'" />' +
	                                    '<span class="k-radio-label"></label>' +
	                                '</label>' +
	                            '</li>' +
	                        '</ul>' +
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-operator-text">#=messages.additionalOperator#</span>' +
	                            ...
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-input-text">#=messages.additionalValue#</span>' +
	                                    '#if(values){#' +
	                    ...
	                    '<li class="k-item k-clear-wrap">' +
	                        '<span class="k-label k-clear" title="#=messages.clear#" ' +
	                        'aria-label="#=messages.clear#">#=messages.clear#</span>' +
	                    '</li>' +
	                '</ul>' +
	            '</form>' +
	        '</div>';
	        ...
	        '<div data-#=ns#role="view" class="k-grid-filter-menu">' +
	            ...
	            '<form title="#=messages.title#" class="k-filter-menu k-mobile-list">' +
	                '<ul>' +
	                    '<li>' +
	                        '<span class="k-filter-help-text">#=messages.info#</span>' +
	                        '<ul class="k-multicheck-bool-wrap">' +
	                            '<li class="k-item"><label class="k-label">' +
	                                '<input id="true_#=filterMenuGuid#" title="#=messages.isTrue#" class="k-check" type="radio" data-#=ns#bind="checked: filters[0].value" value="true" name="filters[0].value" autocomplete="'+AUTOCOMPLETEVALUE+'" />' +
	                                '<span class="k-item-title">#=messages.isTrue#</span>' +
	                            '</label></li>' +
	                            '<li class="k-item"><label class="k-label">' +
	                                '<input id="false_#=filterMenuGuid#" title="#=messages.isFalse#" class="k-check" type="radio" data-#=ns#bind="checked: filters[0].value" value="false" name="filters[0].value" autocomplete="'+AUTOCOMPLETEVALUE+'" />' +
	                                '<span for="false_#=filterMenuGuid#" class="k-item-title">#=messages.isFalse#</span>' +
	                            '</label></li>' +
	                        '</ul>'+
	                    '</li>'+
	                    '<li class="k-item k-clear-wrap">' +
	                ...
	                return "<li class='k-item'>" +
	                          "<label class='k-label'>" +
	                              "<input type='checkbox' class='" + (mobile? "k-check" : "") +"'  value='#:kendo.format('{0"+ valueFormat + "}'," + valueField + ")#'/>" +
	                                 "<span class='k-item-title'>#:kendo.format('" + ( format ?  format  : "{0}" ) + "', "  + field + ")#</span>" +
	                          "</label>" +
	                        "</li>";
	            },
	            checkAll: true,
