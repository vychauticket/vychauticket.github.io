	...
	(function($,undefined) {
	    ...
	    var EditorUtils = {
	        ...
	        buttonTemplate:
	            ...
	            ' unselectable="on" title="#= data.title #" aria-label="#= data.title #"><span unselectable="on" class="k-tool-icon #= iconCssClass #"></span></a>',
	        ...
	        comboBoxTemplate:
	            '<select title="#= data.title #" aria-label="#= data.title #" class="#= data.cssClass #" />',

	        dropDownListTemplate:
	            '<span class="k-editor-dropdown"><select title="#= data.title #" aria-label="#= data.title #" class="#= data.cssClass #" /></span>',
	        ...
	        overflowAnchorTemplate:
	            ...
	            ' unselectable="on" title="#= data.title #" aria-label="#= data.title #" aria-haspopup="true" aria-expanded="false">' +
	            '<span unselectable="on" class="k-icon k-i-more-vertical"></span></a>',
	    ...
	    var Editor = Widget.extend({
	        ...
	        _createContentElement: function(stylesheets) {
	            ...
	            doc.open();
	            doc.write(
	                "<!DOCTYPE html><html lag='" + lang + "'><head>" +
	                "<meta charset='utf-8' />" +
