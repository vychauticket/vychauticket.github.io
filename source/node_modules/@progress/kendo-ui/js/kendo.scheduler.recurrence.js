...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function($, undefined) {
	    ...
	    var RECURRENCE_HEADER_TEMPLATE = kendo.template('<div data-role="content"><ul><li class="k-item"><label class="k-label"><span class="k-item-title">#:headerTitle#</span>' +
	      '<div class="k-recur-pattern"></div></label></li>' +
	      '<li class="k-item k-recur-view"></li></ul></div>'
	    );

	    var RECURRENCE_REPEAT_PATTERN_TEMPLATE = kendo.template(
	        '# if (frequency !== "never") { #' +
	            '<label class="k-label">' +
	                '<span class="k-item-title">#:messages.repeatEvery#</span>' +
	                '<div class="k-recur-editor-wrap">' +
	                    '<input class="k-recur-interval" type="number" pattern="\\\\d*"/>' +
	                    '# if (messages.interval.length) { #' +
	                    '<label class="k-recur-editor-text">#:messages.interval#</label>' +
	                    '# } #' +
	                '</div>' +
	            '</label>' +
	        '# } #' +
	        '# if (frequency === "weekly") { #' +
	            '<ul class="k-recur-items-wrap">' +
	                '<li class="k-item k-no-click"><label class="k-label"><span class="k-item-title">#:messages.repeatOn#</span></label></li>' +
	        ...
	        '# } else if (frequency === "monthly") { #' +
	            '<ul class="k-recur-items-wrap">' +
	                '<li class="k-item">' +
	                    '<label class="k-label">' +
	                        '<span class="k-item-title">#:messages.repeatBy#</span>' +
	                        '<div class="k-repeat-rule"></div>' +
	                    '</label>' +
	                '</li>' +
	                '<li class="k-monthday-view k-item" style="display:none">' +
	                    '<label class="k-label">' +
	                        '<span class="k-item-title">#:messages.day#</span>' +
	                        '<div><input class="k-recur-monthday" type="number" title="#:messages.day#" pattern="\\\\d*"/></div>' +
	                    '</label>' +
	                '</li>' +
	                '<li class="k-weekday-view k-item" style="display:none">' +
	                    '<ul class="k-recur-items-wrap">' +
	                       '<li class="k-item">' +
	                            '<label class="k-label">' +
	                                '<span class="k-item-title">#:messages.every#</span>' +
	                                '<div><select class="k-recur-weekday-offset" title="#:messages.every#"></select></div>' +
	                            '</label>' +
	                        '</li>' +
	                        '<li class="k-item">' +
	                            '<label class="k-label">' +
	                                '<span class="k-item-title">#:messages.day#</span>' +
	                                '<div><select class="k-recur-weekday" title="#:messages.day#"></select></div>' +
	                            '</label>' +
	                        '</li>' +
	                    '</ul>' +
	                '</li>' +
	        ...
	        '# } else if (frequency === "yearly") { #' +
	            '<ul class="k-recur-items-wrap">' +
	                ...
	                '<li class="k-item">' +
	                    '<label class="k-label">' +
	                        '<span class="k-item-title">#:messages.month#</span>' +
	                        '<div><select class="k-recur-month" title="#:messages.month#"></select></div>' +
	                    '</label>' +
	                '</li>' +
	           '</ul>' +
	        '# } #'
	    ...
	    var RECURRENCE_END_PATTERN_TEMPLATE = kendo.template(
	        '# if (endPattern === "count") { #' +
	            '<label class="k-label">' +
	                '<span class="k-item-title">#:messages.after#</span>' +
	                '<div><input class="k-recur-count" type="number" pattern="\\\\d*" /></div>' +
	            '</label>' +
	        '# } else if (endPattern === "until") { #' +
	            '<label class="k-label">' +
	                '<span class="k-item-title">#:messages.on#</span>' +
	                '<div><input type="date" class="k-recur-until" /></div>' +
	            '</label>' +
	        '# } #'
	    );
	    ...
	    var MobileRecurrenceEditor = BaseRecurrenceEditor.extend({
	        ...
	        _initParentRepeatEnd: function() {
	            ...
	            var endEditField = $('<div class="k-scheduler-recur-end-wrap"><span class="k-scheduler-recur-end"></span></div>')
	        ...
	        _initRepeatEnd: function() {
	            ...
	            var endEditField = $('<div class="k-scheduler-recur-end-wrap"><span class="k-scheduler-recur-end"></span><span class="k-icon k-i-arrow-chevron-right"></span></div>')
	                .appendTo(endLabelField.find(".k-label"));
