...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1010), __webpack_require__(1200), __webpack_require__(1012), __webpack_require__(1143), __webpack_require__(1199), __webpack_require__(1299), __webpack_require__(1300), __webpack_require__(1298), __webpack_require__(1301), __webpack_require__(1302), __webpack_require__(1303), __webpack_require__(1212), __webpack_require__(1210), __webpack_require__(1195), __webpack_require__(1213) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	    ...
	    */
	    ...
	    var MobileEditor = Editor.extend({
	        ...
	        editEvent: function(model) {
	            ...
	            html += '<div data-role="view" class="k-popup-edit-form k-scheduler-edit-form k-mobile-list"' + kendo.attr("uid") + '="' + model.uid + '">' +
	                '<div data-role="header" class="k-header">' +
	        ...
	        _bindResourceEvents: function(resourceDS, groupName){
	            ...
	            if(isResourceGrouped) {
	                resourceDS.bind(CHANGE, that._resourceRefreshHandler)
	                    .bind(PROGRESS, that._resourceProgressHandler)
	    ...
	    var MobileTimezoneEditor = Widget.extend({
	        ...
	        _zonePicker: function() {
	            ...
	            that._zonePickerLabel = $("<li class='k-item k-zonepicker' style='display:none'>" +
	                                        "<label class='k-label'><span class='k-item-title'></span>" +
	                                            "<div></div>" +
	                                        "</label>" +
	                                    "</li>");
