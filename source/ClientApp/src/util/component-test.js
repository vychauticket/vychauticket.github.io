...
var ComponentTest = /** @class */ (function () {
    function ComponentTest(template, components) {
        this.template = template;
        this.components = components;
    }
    ComponentTest.prototype.createComponent = function (createOptions) {
        var options = {
    ...
    ComponentTest.prototype.execute = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, callback(this.vm)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
